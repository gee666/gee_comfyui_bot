...
export const make_query_object = (params) => {
  ...
  return ({
    ...
    "prompt": {
      ...
      "141": { "inputs": { "images": ["140", 0] }, "class_type": "PreviewImage" },
      "142": {
        "inputs": {
          "add_noise": "disable",
          "noise_seed": seed,
      ...
      "173": { "inputs": { "images": ["146", 0] }, "class_type": "PreviewImage" }
    },
    "extra_data": {
      "extra_pnginfo": {
        "workflow": {
          ...
          "nodes": [
            ...
            },
            {
              "id": 140,
              "type": "VAEDecode",
              "pos": [1228.0052245117192, -68.92623084228524],
              "size": { "0": 210, "1": 46 },
              "flags": {},
              "order": 22,
              "mode": 0,
            ...
            },
            {
              ...
              "type": "PreviewImage",
              "pos": [1528, -195],
              "size": { "0": 741.5067749023438, "1": 775.4161987304688 },
              "flags": {},
              "order": 24,
              "mode": 0,
              "inputs": [{ "name": "images", "type": "IMAGE", "link": 204 }],
            ...
            },
            {
              ...
              "order": 27,
              "mode": 0,
              "inputs": [{ "name": "images", "type": "IMAGE", "link": 251 }],
              "properties": { "Node name for S&R": "PreviewImage" }
            },
            {
              "id": 155,
            ...
            },
            {
              ...
              "pos": [763.0052245117189, -220.9262308422854],
              "size": { "0": 315, "1": 334 },
              "flags": {},
              "order": 21,
              "mode": 0,
            ...
            },
            {
              ...
              "widgets_values": [target_width, target_height, 1]
            }
          ],
          "links": [
            [57, 4, 2, 32, 0, "*"],
